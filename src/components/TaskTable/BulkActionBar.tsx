...
export function BulkActionBar() {
  ...
  return (
    <div className="pointer-events-none absolute inset-x-0 bottom-4 z-30 flex justify-center">
      <div className="pointer-events-auto flex items-center gap-3 rounded-full border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 px-4 py-2 shadow-xl">
        <span className="text-sm font-medium text-gray-700 dark:text-gray-200">{selectedTaskIds.length} selected</span>
        ...
        <select
          ...
          className="rounded-md border border-gray-200 dark:border-gray-700 px-2 py-1 text-sm text-gray-600 dark:text-gray-300 outline-none focus:border-blue-300"
        >
        ...
        <button
          ...
          className="rounded-md border border-red-200 dark:border-red-900 px-2.5 py-1 text-sm font-medium text-red-600 dark:text-red-400 hover:bg-red-50 dark:hover:bg-red-950"
        >
          Delete
        </button>
        ...
        <button
          ...
          className="flex h-6 w-6 items-center justify-center rounded-full text-gray-400 dark:text-gray-500 hover:bg-gray-100 dark:hover:bg-gray-700 hover:text-gray-700 dark:hover:text-gray-200"
        >
          ✕
        </button>
      </div>
